...
expectedOutput: >-
  ...
  (Why this priority / Independent Test / robust Gherkin acceptance scenarios
  covering happy path, invalid input, duplicate/conflict, boundary limits and
  their transitions, state/permission, and accessibility/non-functional), with
  thin-evidence stories flagged rather than dropped. Clarifying questions where
  input is incomplete.
inputsFrom:
