...
expectedOutput: >-
  ...
  / as-a / i-want / so-that / evidence) plus an expanded block per build-bound
  story (Why this priority / Independent Test / Given-When-Then acceptance
  scenarios). Clarifying questions where input is incomplete.
inputsFrom:
